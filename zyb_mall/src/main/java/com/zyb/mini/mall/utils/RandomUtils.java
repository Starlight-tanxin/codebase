...
public class RandomUtils {
    ...
    public static final Random THREAD_LOCAL_RANDOM = ThreadLocalRandom.current();
    ...
    public static int nextInt() {
        return nextInt(THREAD_LOCAL_RANDOM);
    }
    ...
    public static int nextInt(int n) {
        return nextInt(THREAD_LOCAL_RANDOM, n);
    }
    ...
    public static long nextLong() {
        return nextLong(THREAD_LOCAL_RANDOM);
    }
    ...
    public static boolean nextBoolean() {
        return nextBoolean(THREAD_LOCAL_RANDOM);
    }
    ...
    public static float nextFloat() {
        return nextFloat(THREAD_LOCAL_RANDOM);
    }
    ...
    public static double nextDouble() {
        return nextDouble(THREAD_LOCAL_RANDOM);
    }
