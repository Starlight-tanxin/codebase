...
public final class RedisUtils {
     ...
     */
    public static boolean hmset(RedisTemplate redisTemplate, String key, Map<String, Object> map) {
        try {
     ...
     * @return true成功 false失败
     */
    public static boolean hmset(RedisTemplate redisTemplate, String key, Map<String, Object> map, long time) {
        try {
            redisTemplate.opsForHash().putAll(key, map);
            if (time > 0) {
     ...
     * @return
     */
    public static Set<Object> smembers(RedisTemplate redisTemplate, String key) {
        try {
     ...
     * @return true 存在 false不存在
     */
    public static boolean sismember(RedisTemplate redisTemplate, String key, Object value) {
        try {
     ...
     * @return 成功个数
     */
    public static long sadd(RedisTemplate redisTemplate, String key, Object... values) {
        try {
     ...
     * @return 成功个数
     */
    public static long sadd(RedisTemplate redisTemplate, String key, long time, Object... values) {
        try {
     ...
     * @return set缓存的长度
     */
    public static long scard(RedisTemplate redisTemplate, String key) {
        try {
     ...
     * @return 移除的个数
     */
    public static long srem(RedisTemplate redisTemplate, String key, Object... values) {
        try {
     ...
     * @return
     */
    public static long llen(RedisTemplate redisTemplate, String key) {
        try {
     ...
     * @return
     */
    public static Object lindex(RedisTemplate redisTemplate, String key, long index) {
        try {
     ...
     * @return
     */
    public static boolean rpush(RedisTemplate redisTemplate, String key, Object value) {
        try {
     ...
     * @return
     */
    public static boolean rpush(RedisTemplate redisTemplate, String key, Object value, long time) {
        try {
            redisTemplate.opsForList().rightPush(key, value);
            if (time > 0) {
                expire(redisTemplate, key, time);
     ...
     * @return
     */
    public static boolean rpush(RedisTemplate redisTemplate, String key, List<Object> value) {
        try {
     ...
     * @return
     */
    public static boolean rpush(RedisTemplate redisTemplate, String key, List<Object> value, long time) {
        try {
            redisTemplate.opsForList().rightPushAll(key, value);
            if (time > 0) {
                expire(redisTemplate, key, time);
     ...
     * @return
     */
    public static boolean lset(RedisTemplate redisTemplate, String key, long index, Object value) {
        try {
     ...
     * @return 移除的个数
     */
    public static long lrem(RedisTemplate redisTemplate, String key, long count, Object value) {
        try {
