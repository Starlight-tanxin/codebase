...
public class AddBookParam {
    ...
    @ApiModelProperty(value = "商品编号", example = Mock.NUMBER, required = true)
    ...
    @ApiModelProperty(value = "商品主图", example = Mock.NUMBER, required = true)
    @NotNull(message = "商品主图不能为空")
    private String mainImg;

    @ApiModelProperty(value = "商品名字", example = Mock.NUMBER, required = true)
    @NotNull(message = "商品名字不能为空")
    private String goodsName;

    @ApiModelProperty(value = "作者", example = Mock.NUMBER, required = true)
    @NotNull(message = "商品名字不能为空")
    ...
    @ApiModelProperty(value = "纸张", example = Mock.NUMBER, required = true)
    @NotNull(message = "纸张不能为空")
    private String bookPaper;


    @ApiModelProperty(value = "尺寸", example = Mock.NUMBER, required = true)
    @NotNull(message = "尺寸不能为空")
    private String bookSize;

    @ApiModelProperty(value = "图书描述", example = Mock.NUMBER, required = true)
    ...
    @ApiModelProperty(value = "其他种类", example = Mock.NUMBER)
    private Integer bookOtherTypeId;

    @ApiModelProperty(value = "是否上架：\n0.下架\n1.上架", example = Mock.TRUE, required = true)
