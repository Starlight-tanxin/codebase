package com.dome.mp.server.generator;
...
public class CodeGenerator {
    ...
    public static void main(String[] args) {
        ...
        dsc.setUrl("jdbc:mysql://115.29.109.0:13306/demo?useSSL=false&characterEncoding=utf-8&serverTimezone=Asia/Shanghai");
        // dsc.setSchemaName("public");
        dsc.setDriverName("com.mysql.cj.jdbc.Driver");
        dsc.setUsername("tanxin");
        dsc.setPassword("tanxin#a1B2c#");
